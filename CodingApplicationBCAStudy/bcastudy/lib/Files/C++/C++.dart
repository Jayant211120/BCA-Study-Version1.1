...
import '../theoryContent.dart';
class cplusplusContent extends StatelessWidget {
  const cplusplusContent({super.key});
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: ThemeData.dark(),
      debugShowCheckedModeBanner: false,
      home: const CPPTheory(),
    );
  }
}
class CPPTheory extends StatelessWidget {
  const CPPTheory({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body:SfPdfViewer.asset('assets/pdfs/c++.pdf')
