...
import 'Statistics/statisticsVideoesList.dart';
class mathsContent extends StatelessWidget {
  const mathsContent({super.key});
  @override
                      ...
                      children: [
                        Container(height: 100,width: 100,decoration: BoxDecoration(
                          ...
                          gradient: const LinearGradient(colors: [Colors.blueAccent,Colors.purple]),
                            ...
                            child:ElevatedButton(onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context)=>const statisticsVideoList()));},style: ElevatedButton.styleFrom(
