...
import 'package:bcastudy/Files/HTML/html_content.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      AppBar(
        ...
        toolbarHeight: 100,
        actions: [
          IconButton(onPressed: (){Navigator.push(context,MaterialPageRoute(builder: (context)=>const courses()));}, icon:const Icon( Icons.arrow_back)),
      ...
      body:SingleChildScrollView(
       ...
       child:Column(
        children: [
          const Center(
            child:Text('Theory Content',style: TextStyle(fontSize: 40,color: Colors.cyan),),
          ),
          SingleChildScrollView(
            ...
            child: Row(
              ...
              children:[
                  ...
                  children: [
                    Container(height: 100,width: 100,decoration: BoxDecoration(
                      ...
                      gradient: const LinearGradient(colors: [Colors.blueAccent,Colors.purple]),
                        ...
                        child:ElevatedButton(onPressed: () {Navigator.push(context,MaterialPageRoute(builder: (context)=>const cplusplusContent()));},style: ElevatedButton.styleFrom(
                ...
                //       gradient: const LinearGradient(colors: [Colors.blueAccent,Colors.purple]),
                //     ),
                //         child:ElevatedButton(onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context)=>mathsContent2()));},style: ElevatedButton.styleFrom(
                //             backgroundColor: Colors.cyan
